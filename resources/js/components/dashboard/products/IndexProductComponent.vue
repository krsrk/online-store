            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <v-text-field v-model="editedItem.descr" label="Descripcion"></v-text-field>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
                  ...
                  <v-col cols="12" sm="6" md="4">
                     <v-select :items="items" label="Special"></v-select>
                  </v-col>
                  <v-col cols="12" sm="6" md="4">
  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'special', value: 'is_special', sortable: false },
        { text: 'stock', value: 'stock', sortable: false },
        { text: 'special', value: 'is_special', sortable: false },
        { text: 'Fecha de creación', value: 'created_at', sortable: false },
        { text: 'Fecha de publicación', value: 'is_special', sortable: false }
      ],
      desserts: [],
      editedIndex: -1,
      editedItem: {
